        		...
        		<div class="row welcome_inner">
        			<div class="col-lg-6">
        				<div class="welcome_text">
        					<h4>About Myself</h4>
        					<p>As a frontend and backend developer, app developer, and project manager, I turn business ideas into reality with seamless, automated solutions, enhancing efficiency and ensuring smooth project execution from start to finish.</p>
        					<div class="row">
        						<div class="col-sm-4">
        							<div class="wel_item">
