            ...
            <div class="main_menu" id="mainNav">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container box_1620">
						...
						<!-- <a class="navbar-brand logo_h" href="</?= base_url() ?>"><img src="</?= base_url() ?>asset/img/logo.png" alt=""></a> -->
						<a class="navbar-brand logo_h" href="<?= base_url() ?>" style="font-weight: bold; font-size:30px;">CEBASTIEN</a>
